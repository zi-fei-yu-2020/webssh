        ...
        <el-form :inline="true" :model="formInline" label-position="left">
          <el-form-item label="主机：">
            <el-input
              ...
              maxlength="60"
              clearable
              placeholder="服务器IP/域名"
              @change="search"
              style="width: 200px"
            ></el-input>
          </el-form-item>
          <el-form-item label=""
            ><el-button @click="getData" type="primary" icon="Search"
              >查询</el-button
            ></el-form-item
          >
          <el-form-item label=""
      ...
      <el-table-column label="操作" fixed="right" width="170">
        ...
        <template #default="scope">
          ...
          <el-button
            size="mini"
            type="text"
            @click="showRejectDelete(scope.row.id)"
          >
            删除
          </el-button>
        </template>
      ...
      >
        <el-row>
          ...
          <el-col :span="24" v-if="formData.type == '1'">
            <el-form-item label="私钥：" prop="pkey">
              <el-input
            ...
            <el-form-item label="私钥密码：" prop="pkey_passwd">
...
const device_rules = {
  ...
  username: [{ required: true, message: "请输入SSH账号", trigger: "blur" }],
};
...
function opencontent(row) {
  ...
  window.open(
    baseurl + "/terminal?id=" + row.id + "&host=" + row.host,
    "_blank"
  );
}
